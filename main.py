...
SPAWNS = [
    ...
    ("White Wizard", 16, 45), ("White Wizard", 21, 20), ("White Wizard", 0, 45),

    ("Dourados", 0, 0), ("Dourados", 4, 0), ("Dourados", 8, 0),
    ("Dourados", 12, 0), ("Dourados", 16, 0),

    ("Red Dragon", 8, 35), ("Red Dragon", 12, 35),
    ("Red Dragon", 16, 35), ("Red Dragon", 21, 20), ("Red Dragon", 0, 35),

    ("Skeleton King", 8, 25), ("Skeleton King", 12, 25),
    ("Skeleton King", 16, 25), ("Skeleton King", 21, 20), ("Skeleton King", 0, 25),
]
